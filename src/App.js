        ...
        <>
            ...
            <Routes>
                <Route
                    ...
                    path="/"
                    element={
                        // <Landing deptypes={deptypes} doctypes={doctypes} getAllDeptDocs={getAllDeptDocs} />
                        <Landing />
                    }
                />
                <Route
                ...
                <Route exact path="/configure" element={<Configure deptypes={deptypes} doctypes={doctypes} getAllDoctypes={getAllDoctypes} />} />
            </Routes>
        </>
    );
}
